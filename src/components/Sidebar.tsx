            ...
            {filteredUsers.map((user, index) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <span className={`bg-${user.unreadCount > 0 ? "orange-500" : "transparent"} text-white text-center rounded-full px-[5px] py-[1px]`}>
...
//         <div className="flex-1 overflow-y-auto rounded-lg shadow-xl p-4 space-y-1">
//           <h1 className="font-semibold">People</h1>
//           <div>
//             {/* Individual People items */}
//             {filteredUsers.map((user, index) => (
//               <div key={index} className="flex justify-between items-center space-x-12 border-b border-gray-300 pb-1"
